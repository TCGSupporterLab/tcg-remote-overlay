...
特に「遊戯王OCG」および「ホロライブOCG」の対戦サポート（ツール機能）に対応しています。

## 🌟 主な機能

### 🎤 ホロライブモード [NEW]
- **カード検索機能**:
  - 全1,700枚以上のカードデータから高速検索
  - 色、カードタイプ、Bloomレベルによるマルチフィルタリング
  - キーワード検索（ひらがな・カタカナ・英数字対応、記号無視）
- **ピン留め機能**: 
  - 10枚までお気に入り登録可能。
  - ピン留めしたカードのみをオーバーレイ表示する「ピン留めタブ」
- **カード詳細表示**: 
  - 選択したカードを左側に大きく表示（配信中の視認性を向上）
