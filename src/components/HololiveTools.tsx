                ...
                <div className="relative flex flex-col items-center justify-center w-fit mx-auto pointer-events-auto">
                    ...
                    {isOverlayEnabled && (
                        <div className="relative flex flex-col items-center justify-start rounded-2xl animate-in zoom-in duration-500 transform overflow-hidden"
                            ...
                            <div className="absolute inset-0 z-30 flex flex-col items-center pointer-events-none p-4">
                                <div className={`flex flex-col items-center w-full h-full transition-all duration-500 ${isRotated ? 'justify-end pb-2' : 'justify-start pt-2'}`}>
                                    <div className="pointer-events-auto shadow-2xl rounded-xl bg-black/20 backdrop-blur-sm p-2">
                                        <OverlayDisplay
                                            diceValue={diceValue}
                                            coinValue={coinValue}
                                            diceKey={diceKey}
