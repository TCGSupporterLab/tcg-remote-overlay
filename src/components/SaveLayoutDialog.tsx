...
export const SaveLayoutDialog = ({ isOpen, onClose, onSave, initialOptions, source }: SaveLayoutDialogProps) => {
    ...
    return (
        <div
            className="fixed inset-0 z-[4000] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200 save-layout-dialog-overlay app-modal-overlay"
            onClick={onClose}
        >
            <div
